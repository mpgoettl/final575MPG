...
function setMap(){
    ...
    var promises = [];
    promises.push(d3.csv("data/reportcardHS.csv")); //load attributes from csv
    promises.push(d3.json("data/background.topojson")); //load background spatial data
    promises.push(d3.json("data/hsBound.topojson")); //load choropleth spatial data
    ...
    function callback(data){
        ...
        var UScountries = topojson.feature(usCountries, usCountries.objects.background),
            usSTATES = topojson.feature(USA, USA.objects.hsBound).features;
